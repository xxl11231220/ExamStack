					...
					<div class="lrform">
						...
						<div class="form">
							...
							<form class="form-horizontal" action="j_spring_security_check"
								...
								<!-- Kaptcha -->
								<div class="form-group">
									<label class="control-label col-md-3" for="password">验证码</label>
									<div class="col-md-9">
										<img id="kaptcha" alt="点击更换验证码" src="./Kaptcha.jpg"
											style="float: left;"><input type="password"
											class="form-control" style="width: 70%;" name="validate_code">
									</div>
								</div>
								<!-- Buttons -->
								<div class="form-group">
	...
	<script type="text/javascript">
		...
		$(function() {
			$("#kaptcha").on("click", function() {
				...
				var rand = randomChar(16);
				$(this).attr("src", url + "?rand=" + rand);
			});
		});
	</script>
</body>
